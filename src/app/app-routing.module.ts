...
const routes: Routes = [
  ...
  { path: 'signos', component: SignosComponent, children: [{path: 'nuevo', component: SignosEdicionComponent, children: [{path: 'signosPaciente', component: SignosPacienteComponent}]},
  {path: 'edicion/:id', component: SignosEdicionComponent}], canActivate: [GuardService] },
